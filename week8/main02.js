function main()
{
    ...
    for ( var i = 0; i < 256; i++ )
    {
        ...
        var G = Math.max( Math.cos( S * Math.PI *0.5 ), 0.0 );
        var B = Math.max( Math.cos( S * Math.PI *0.5 ), 0.0 );
    ...
    {
        var id = faces[i];
        var S0 = Math.round((scalars[ id[0] ]-0.1)*255/(scalars[id[2]]-scalars[id[0]]));
        var S1 = Math.round((scalars[ id[1] ]-0.1)*255/(scalars[id[2]]-scalars[id[0]]));
        var S2 = Math.round((scalars[ id[2] ]-0.1)*255/(scalars[id[2]]-scalars[id[0]]));
